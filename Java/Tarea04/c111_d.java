...
/**
 * Write a description of class SparringScore here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class c111_d implements  ActionListener{
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("[=] Sparring Score [=]");

        //Create and set up the content pane.
        c111_d demo = new c111_d();
